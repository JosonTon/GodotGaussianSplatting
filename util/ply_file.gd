...
static func load_gaussian_splats(point_cloud : PlyFile, stride : int, output : PackedFloat32Array, should_terminate_reference : Array[bool], num_points_loaded : Array[int], callback : Callable):
